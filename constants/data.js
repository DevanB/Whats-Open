    ...
    data: [
      {
        ...
        location: { address1: '13501 W Colonial Drive', city: 'Winter Garden', state: 'FL', zip_code: '34787' },
        description: '',
        user_defined: {
          status: OPEN,
      ...
      },
      {
        ...
        location: { address1: '16313 New Independence Pkwy', city: 'Winter Garden', state: 'FL', zip_code: '34787' },
        description: '',
        user_defined: {
          status: OPEN,
      ...
      },
      {
        ...
        location: { address1: '3089 Daniels Road', city: 'Winter Garden', state: 'FL', zip_code: '34787' },
        description: '',
        user_defined: {
          status: LIMITED,
      ...
      },
      {
        ...
        location: { address1: '1236 Hempel Avenue', city: 'Windermere', state: 'FL', zip_code: '34786' },
        description: '',
        user_defined: {
          status: CLOSED,
      ...
      },
      {
        ...
        location: { address1: '5400 Hamlin Groves Trail', city: 'Winter Garden', state: 'FL', zip_code: '34787' },
        description: '',
        user_defined: {
          status: LIMITED,
      ...
      },
      {
        ...
        location: { address1: '4326 Isabella Cir', city: 'Windermere', state: 'FL', zip_code: '34786' },
        description: '',
        user_defined: {
          status: OPEN,
